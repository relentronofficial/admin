...
npm test                 # Vitest — scoped to src/modules/ads/**/*.test.ts + src/lib/{batchReportLogic,onboardingLogic,onboardingMeetingLogic,weekChecklistLogic,chatMessageActionRules}.test.ts (pure unit, no DB/network)
