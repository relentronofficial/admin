...
export default defineConfig({
  test: {
    include: ['src/modules/ads/**/*.test.ts', 'src/lib/batchReportLogic.test.ts', 'src/lib/onboardingLogic.test.ts', 'src/lib/onboardingMeetingLogic.test.ts', 'src/lib/weekChecklistLogic.test.ts', 'src/lib/chatMessageActionRules.test.ts', 'src/lib/lessonProgression.test.ts'],
    environment: 'node',
