...
async function prismaPlugin(fastify: FastifyInstance, opts: FastifyPluginOptions) {
  ...
  try {
    ...
    await Promise.all([
      ...
      prisma.$executeRawUnsafe(`ALTER TABLE ebooks ADD COLUMN IF NOT EXISTS author_id UUID`),
      prisma.$executeRawUnsafe(`ALTER TABLE ebooks ADD COLUMN IF NOT EXISTS view_count INT NOT NULL DEFAULT 0`),
      prisma.$executeRawUnsafe(`ALTER TABLE ebooks ADD COLUMN IF NOT EXISTS isbn VARCHAR(32)`),
      prisma.$executeRawUnsafe(`ALTER TABLE ebooks ADD COLUMN IF NOT EXISTS language VARCHAR(16) DEFAULT 'en'`),
      prisma.$executeRawUnsafe(`ALTER TABLE ebooks ADD COLUMN IF NOT EXISTS publisher_id UUID`),
